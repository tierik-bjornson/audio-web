...
const albumItem = [
    {id:1, name:'ZX9 SPEAKER', img:img_speaker, navigate:'HeadPhones', svg:img_pattern_circles_lg, desc:'Upgrade to premium speakers that are phenomenally built to deliver truly remarkable sound.'},
    {id:2, name:'ZX7 SPEAKER', img:img_speaker2, navigate:'HeadPhones', svg:'', desc:''},
    {id:3, name:'YX1 EARPHONES', img:img_earPhone, navigate:'EarPhone', svg:'', desc:''},
]
    ...
    <section id='homeAlbum'>
      <div className='albumBoxFullOrange boxRow'>
        ...
        <div className='albumBoxFullOrangeRight boxColumn gap_2 left'>
            ...
            <Link to={albumItem[0].desc} className='btn_black selfLeft' >SEE PRODUCT</Link>
        </div>
      </div>
      ...
      <div className='albumBoxFullGray boxRow'>
        <div className='albumBoxFullGrayLeft gap_2'>
            ...
            <Link to={albumItem[1].desc} className='btn_transparent selfLeft' >SEE PRODUCT</Link>
        </div>
      ...
      <div className='albumBoxHulf boxRow'>
        ...
        <div className='albumBoxHulfRight albumBoxHulfWidth boxColumn gap_2'>
            ...
            <Link to={albumItem[2].desc} className='btn_transparent selfLeft' >SEE PRODUCT</Link>
        </div>
    </div>
    </section>
  )
